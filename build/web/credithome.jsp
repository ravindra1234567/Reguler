...
<a href="#"><button class="btn btn-primary" style="margin-left: 10px;" onclick=" window.history.back();"><i class="fas fa-long-arrow-alt-left"></i> &nbsp;Go Back</button></a>
       ...
       <%
        /* String s=(String)session.getAttribute("valid");
         if(s==null)
             response.sendRedirect("edpuser.jsp");
         else if(s.equals("0"))
            {
                response.sendRedirect("edpuser.jsp");
            }*/
           ...
           /* Class.forName(pageContext.getServletContext().getInitParameter("DriverName"));
            Connection con=DriverManager.getConnection(pageContext.getServletContext().getInitParameter("Url"),pageContext.getServletContext().getInitParameter("DBUserName"), pageContext.getServletContext().getInitParameter("DBPassword"));
*/
                        ...
                        <tbody>
                           ...
                           %>
                            <tr>
                                ...
                                <td><%=s1%></td>
                                <td><%=s2%></td>
                                <td><input type="text" value ="<%=s3%>" id="<%=s1%>1" name="<%=s1 %>1" onkeyup="cal('<%=s1 %>1')"></td>
                                <td><input type="text" value ="<%=s4%>" id="<%=s1%>2" name="<%=s1 %>2" onkeyup="cal('<%=s1 %>2')"></td>
                            </tr>
                            <% }
                            ...
                            <center><input type="submit" value="Save Credits"></center>
                        </form>
                            </center>
                </div>
            </div>
