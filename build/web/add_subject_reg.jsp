            ...
            <div class="input_fields_wrap">
                ...
                <div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-2"><label>Subject Code<sup class="text-danger">*</sup></label><input type="text" name="[]" class="form-control" placeholder="Subject Code"/></div>
                        <div class="col-2 "><label>Subject Name<sup class="text-danger">*</sup></label><input type="text" name="text[]" class="form-control" placeholder="Subject Name"/></div>
                        <div class="col-2"> 
                            <label>Theory Credit<sup class="text-danger">*</sup></label>
                            <select name="theorycredit[]" class="form-control">
                        ...
                        <div class="col-2">
                            ...
                            <select name="practicalcredit[]" class="form-control">
